...
describe("vendor portal — INVARIANT 1: no authorization identifier comes from the caller", () => {
  ...
  it("every route is behind the flag AND the session resolver", () => {
    ...
    // Eleven, which is the full planned portal surface: session exchange and
    // sign-out, engagement read, questionnaire read and save, submit, evidence
    // upload / list / withdraw, and the comment thread read and post.
