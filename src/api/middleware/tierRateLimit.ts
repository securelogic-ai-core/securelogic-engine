...
export async function tierRateLimit(
  ...
  try {
    ...
    // The DB vocabulary is starter/standard/premium; map to the rate-limit
    // vocabulary free/paid/admin. Default to free so unconfigured keys are
    // never granted elevated limits.
