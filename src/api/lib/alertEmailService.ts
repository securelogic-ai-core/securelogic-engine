...
// Transport, suppression, ledger, and render helpers now live in
// ./alerting/alertPrimitives.ts so the coalescing alert service shares them.
// (Behavior unchanged — same env vars, same SQL, same tables.)
