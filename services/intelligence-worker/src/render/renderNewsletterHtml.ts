...
<div style="max-width:680px;margin:0 auto;padding:24px 16px 48px;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;">
      ...
      <div style="text-align:right;">
        ...
        <div style="font-size:11px;color:#64748b;margin-top:3px;font-style:italic;">
          ${issue.signalCount ? `${issue.signalCount} signals analysed` : "Enterprise Risk Intelligence"}
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="background:#1e293b;padding:18px 32px;border-bottom:3px solid #0d9488;">
    <div style="font-size:11px;color:#64748b;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:6px;">
      Executive Takeaway
    </div>
    <div style="font-size:15px;font-weight:600;color:#e2e8f0;line-height:1.5;">
  ...
  <div style="background:#ffffff;border-radius:0 0 12px 12px;padding:28px 32px;">
    ...
    <div style="margin-top:36px;padding-top:20px;border-top:1px solid #e5e7eb;">
      <div style="font-size:12px;color:#9ca3af;line-height:1.6;">
        <strong style="color:#374151;">SecureLogic AI</strong> — Enterprise Risk Intelligence Platform<br />
        This brief is generated by the SecureLogic Engine and curated for risk, compliance, and governance leaders.
      </div>
    </div>
