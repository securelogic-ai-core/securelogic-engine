...
/**
 * SL-EVID-1: the mapping moved to lib/evidenceErrorCopy so the control,
 * obligation and AI-system upload forms share it instead of printing raw
 * engine codes at the customer. This wrapper keeps the call sites below
 * unchanged and pins this surface's accepted-type list.
 */
function uploadErrorMessage(raw: string): string {
  return evidenceUploadErrorMessage(raw, EVIDENCE_ACCEPTED_LABEL);
}
